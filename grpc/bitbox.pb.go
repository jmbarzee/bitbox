...
type StatusReply_StatusEnum int32

const (
	// Running indicates that the process is running.
	StatusReply_Running StatusReply_StatusEnum = 0
	// Exited indicates that the process returned a non-zero exit code.
	StatusReply_Exited StatusReply_StatusEnum = 1
	// Stopped indicates that the process returned no exit code.
	StatusReply_Stopped StatusReply_StatusEnum = 2
)

// Enum value maps for StatusReply_StatusEnum.
var (
	StatusReply_StatusEnum_name = map[int32]string{
		0: "Running",
		1: "Exited",
		2: "Stopped",
	}
	StatusReply_StatusEnum_value = map[string]int32{
		"Running": 0,
		"Exited":  1,
		"Stopped": 2,
	}
...
func (x StatusReply_StatusEnum) Enum() *StatusReply_StatusEnum {
	p := new(StatusReply_StatusEnum)
	*p = x
	return p
}

func (x StatusReply_StatusEnum) String() string {
	return protoimpl.X.EnumStringOf(x.Descriptor(), protoreflect.EnumNumber(x))
}

func (StatusReply_StatusEnum) Descriptor() protoreflect.EnumDescriptor {
	return file_bitbox_proto_enumTypes[0].Descriptor()
}

func (StatusReply_StatusEnum) Type() protoreflect.EnumType {
	return &file_bitbox_proto_enumTypes[0]
}

func (x StatusReply_StatusEnum) Number() protoreflect.EnumNumber {
	return protoreflect.EnumNumber(x)
}

// Deprecated: Use StatusReply_StatusEnum.Descriptor instead.
func (StatusReply_StatusEnum) EnumDescriptor() ([]byte, []int) {
...
type StatusReply struct {
	...
	Status StatusReply_StatusEnum `protobuf:"varint,1,opt,name=Status,proto3,enum=grpc.StatusReply_StatusEnum" json:"Status,omitempty"`
}
...
func (x *StatusReply) GetStatus() StatusReply_StatusEnum {
	if x != nil {
		return x.Status
	}
	return StatusReply_Running
}
...
func (x *QueryReply) GetStdouterr() string {
	if x, ok := x.GetOutput().(*QueryReply_Stdouterr); ok {
		return x.Stdouterr
	}
	return ""
}
...
type QueryReply_Stdouterr struct {
	// Stdouterr is any output from the process which was written to Stdouterr.
	Stdouterr string `protobuf:"bytes,1,opt,name=Stdouterr,proto3,oneof"`
}

type QueryReply_ExitCode struct {
	// ExitCode is the code the process exited with.
	ExitCode uint32 `protobuf:"varint,3,opt,name=ExitCode,proto3,oneof"` // Leaving as 3 to allow for seperation of Stdout & Stderr at some point
}

func (*QueryReply_Stdouterr) isQueryReply_Output() {}
...
var file_bitbox_proto_rawDesc = []byte{
	...
	,
	...
	0x22, 0x54, 0x0a, 0x0a, 0x51, 0x75, 0x65, 0x72, 0x79, 0x52, 0x65, 0x70, 0x6c, 0x79, 0x12, 0x1e,
	0x0a, 0x09, 0x53, 0x74, 0x64, 0x6f, 0x75, 0x74, 0x65, 0x72, 0x72, 0x18, 0x01, 0x20, 0x01, 0x28,
	0x09, 0x48, 0x00, 0x52, 0x09, 0x53, 0x74, 0x64, 0x6f, 0x75, 0x74, 0x65, 0x72, 0x72, 0x12, 0x1c,
	0x0a, 0x08, 0x45, 0x78, 0x69, 0x74, 0x43, 0x6f, 0x64, 0x65, 0x18, 0x03, 0x20, 0x01, 0x28, 0x0d,
	0x48, 0x00, 0x52, 0x08, 0x45, 0x78, 0x69, 0x74, 0x43, 0x6f, 0x64, 0x65, 0x42, 0x08, 0x0a, 0x06,
	0x4f, 0x75, 0x74, 0x70, 0x75, 0x74, 0x32, 0xce, 0x01, 0x0a, 0x06, 0x42, 0x69, 0x74, 0x42, 0x6f,
	0x78, 0x12, 0x2f, 0x0a, 0x05, 0x53, 0x74, 0x61, 0x72, 0x74, 0x12, 0x12, 0x2e, 0x67, 0x72, 0x70,
	...
	,
}
...
var file_bitbox_proto_goTypes = []interface{}{
	(StatusReply_StatusEnum)(0), // 0: grpc.StatusReply.StatusEnum
...
var file_bitbox_proto_depIdxs = []int32{
	0, // 0: grpc.StatusReply.Status:type_name -> grpc.StatusReply.StatusEnum
	1, // 1: grpc.BitBox.Start:input_type -> grpc.StartRequest
	3, // 2: grpc.BitBox.Stop:input_type -> grpc.StopRequest
	5, // 3: grpc.BitBox.Status:input_type -> grpc.StatusRequest
	7, // 4: grpc.BitBox.Query:input_type -> grpc.QueryRequest
	2, // 5: grpc.BitBox.Start:output_type -> grpc.StartReply
	4, // 6: grpc.BitBox.Stop:output_type -> grpc.StopReply
	6, // 7: grpc.BitBox.Status:output_type -> grpc.StatusReply
	8, // 8: grpc.BitBox.Query:output_type -> grpc.QueryReply
